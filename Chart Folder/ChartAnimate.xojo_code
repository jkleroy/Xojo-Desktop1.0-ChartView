...
Protected Module ChartAnimate
	...
	#tag Method, Flags = &h1
		Protected Function getEaseValue(method as integer, time as double, beginningValue as double, changeInValue as double, duration as double) As double
		  ...
		  case ChartAnimate.kLinearTween
		    return ChartAnimate.linearTween(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInQuad
		    return ChartAnimate.easeInQuad(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseOutQuad
		    return ChartAnimate.easeOutQuad(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInOutQuad
		    return ChartAnimate.easeInOutQuad(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInCubic
		    return ChartAnimate.easeInCubic(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseOutCubic
		    return ChartAnimate.easeOutCubic(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInOutCubic
		    return ChartAnimate.easeInOutCubic(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInQuart
		    return ChartAnimate.easeInQuart(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseOutQuart
		    return ChartAnimate.easeOutQuart(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInOutQuart
		    return ChartAnimate.easeInOutQuart(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInQuint
		    return ChartAnimate.easeInQuint(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseOutQuint
		    return ChartAnimate.easeOutQuint(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInOutQuint
		    return ChartAnimate.easeInOutQuint(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInSine
		    return ChartAnimate.easeInSine(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseOutSine
		    return ChartAnimate.easeOutSine(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInOutSine
		    return ChartAnimate.easeInOutSine(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInExpo
		    return ChartAnimate.easeInExpo(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseOutExpo
		    return ChartAnimate.easeOutExpo(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInOutExpo
		    return ChartAnimate.easeInOutExpo(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInCirc
		    return ChartAnimate.easeInCirc(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseOutCirc
		    return ChartAnimate.easeOutCirc(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInOutCirc
		    return ChartAnimate.easeInOutCirc(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInElastic
		    return ChartAnimate.easeInElastic(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseOutElastic
		    return ChartAnimate.easeOutElastic(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInOutElastic
		    return ChartAnimate.easeInOutElastic(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInBack
		    return ChartAnimate.easeInBack(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseOutBack
		    return ChartAnimate.easeOutBack(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInOutBack
		    return ChartAnimate.easeInOutBack(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInBounce
		    return ChartAnimate.easeInBounce(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseOutBounce
		    return ChartAnimate.easeOutBounce(time, beginningValue, changeInValue, duration)
		    
		  case ChartAnimate.kEaseInOutBounce
		    return ChartAnimate.easeInOutBounce(time, beginningValue, changeInValue, duration)
